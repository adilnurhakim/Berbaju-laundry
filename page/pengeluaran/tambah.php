...
if (isset($_POST['tambah'])) {
  ...
  // cek duplikasi id_pengeluaran
  $cek_id = mysqli_query($conn, "SELECT id_pengeluaran FROM tb_pengeluaran WHERE id_pengeluaran = '$id_pengeluaran'");
  if (mysqli_num_rows($cek_id) > 0) {
    $pesan_error .= "ID Pengeluaran $id_pengeluaran sudah digunakan, silakan coba lagi.";
  } else {
